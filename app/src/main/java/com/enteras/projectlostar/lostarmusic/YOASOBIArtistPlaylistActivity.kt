...
class YOASOBIArtistPlaylistActivity : AppCompatActivity() {
    ...
    private fun displayMusicList() {
        ...
        val musicList = listOf(
            ...
            MusicData("怪物", "YOASOBI", "3:26", R.drawable.music_album_icon_32, R.raw.music39),
            MusicData("勇者", "YOASOBI", "3:24", R.drawable.music_album_icon_31, R.raw.music38)
        )

        // RecyclerView 초기화
        val recyclerView = findViewById<RecyclerView>(R.id.recyclerView)
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.adapter =YOASOBIArtistPlaylistAdapter(this, musicList)
    }
}

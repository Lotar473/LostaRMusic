...
class YOASOBIArtistPlaylistAdapter(private val context: Context, private val musicList: List<MusicData>) :
    RecyclerView.Adapter<YOASOBIArtistPlaylistAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        override fun onClick(view: View?) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                val musicData = musicList[position]
                val intent = Intent(context, YOASOBIArtistPlaylistMusicPlayerActivity::class.java).apply {

...
class HansZimmerArtistPlaylistAdapter(private val context: Context, private val musicList: List<MusicData>) :
    RecyclerView.Adapter<HansZimmerArtistPlaylistAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        override fun onClick(view: View?) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                val musicData = musicList[position]
                val intent = Intent(context, HansZimmerArtistPlaylistMusicPlayerActivity::class.java).apply {

...
class TheFatRatArtistPlaylistAdapter(private val context: Context, private val musicList: List<MusicData>) :
    RecyclerView.Adapter<TheFatRatArtistPlaylistAdapter.ViewHolder>() {

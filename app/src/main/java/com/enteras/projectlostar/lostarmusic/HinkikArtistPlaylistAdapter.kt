...
class HinkikArtistPlaylistAdapter(private val context: Context, private val musicList: List<MusicData>) :
    RecyclerView.Adapter<HinkikArtistPlaylistAdapter.ViewHolder>() {

...
class TheFatRatArtistPlaylistMusicPlayerActivity : AppCompatActivity() {
    ...
    private fun initMusicList() {
        ...
        musicList.add(MusicData("Still Here With You", "TheFatRat", "2:28", R.drawable.music_album_icon_18, R.raw.music18))
        musicList.add(MusicData("MAYDAY", "TheFatRat, Laura Brehm", "4:07", R.drawable.music_album_icon_19, R.raw.music19))
        musicList.add(MusicData("Fly Away", "TheFatRat, Anjulie", "3:14", R.drawable.music_album_icon_20, R.raw.music20))
    }
